...
//                            startActivity(intent);
                            ...
                            messageView1.setText("Ngayon ay i-set naman natin ang iyong 4 digit pin code para sa inyong password sa NAN.AI App.");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            showAlert("Ang Mobile Number na iyong binigay ay wala sa aming records. Siguraduhin na ikaw ay isang authorized NAN.AI user. Makipag-ugnayan sa iyong PRO kung hindi makapag activate.");
